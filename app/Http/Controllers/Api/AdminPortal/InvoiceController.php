    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => $invoices->through(fn (Invoice $invoice) => [
                ...
                'amount_coin' => $invoice->amount_coin !== null ? $invoice->formattedCoinAmount('amount_coin') : null,
                'expected_usd' => $invoice->expected_usd !== null ? (string) $invoice->expected_usd : null,
                'received_conf_coin' => $invoice->received_conf_coin !== null ? $invoice->formattedCoinAmount('received_conf_coin') : null,
    ...
    public function show(Invoice $invoice): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'received_conf_coin' => $invoice->received_conf_coin !== null ? $invoice->formattedCoinAmount('received_conf_coin') : null,
                'received_all_coin' => $invoice->received_all_coin !== null ? $invoice->formattedCoinAmount('received_all_coin') : null,
                'paid_usd' => $invoice->paid_usd !== null ? (string) $invoice->paid_usd : null,
                'fee_coin' => $invoice->fee_coin !== null ? $invoice->formattedCoinAmount('fee_coin') : null,
                'merchant_payout_coin' => $invoice->merchant_payout_coin !== null ? $invoice->formattedCoinAmount('merchant_payout_coin') : null,
                ...
                'forward_status' => $invoice->forward_status,
                'forwarded_coin' => $invoice->forwarded_coin !== null ? $invoice->formattedCoinAmount('forwarded_coin') : null,
                'forwarding_coin' => $invoice->forwarding_coin !== null ? $invoice->formattedCoinAmount('forwarding_coin') : null,
                'forward_txids' => $invoice->forward_txids ?? [],
                'first_txid' => $invoice->first_txid,
                'first_amount_coin' => $invoice->first_amount_coin !== null ? $invoice->formattedCoinAmount('first_amount_coin') : null,
